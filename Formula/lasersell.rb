class Lasersell < Formula
  ...
  on_macos do
    on_arm do
      url "https://dl.lasersell.io/apt/binaries/lasersell/0.2.2/lasersell_0.2.2_darwin_arm64.tar.gz"
      sha256 "b05c51ac30cba9378038ef153c1af88a7e1bd18ccc372eb56e8ad7573584c3ca"
    end
    on_intel do
      url "https://dl.lasersell.io/apt/binaries/lasersell/0.2.2/lasersell_0.2.2_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://dl.lasersell.io/apt/binaries/lasersell/0.2.2/lasersell_0.2.2_linux_arm64.tar.gz"
      sha256 "f86bdf77bb5288de8f0449a5aa522c2adaa6dea9d71e82480cc774fb521330dd"
    end
    on_intel do
      url "https://dl.lasersell.io/apt/binaries/lasersell/0.2.2/lasersell_0.2.2_linux_amd64.tar.gz"
  ...
  livecheck do
    url "https://dl.lasersell.io/apt/binaries/lasersell/latest.txt"
    regex(/(\d+\.\d+\.\d+)/)
  end
end
